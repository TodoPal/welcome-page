...
export function Background() {
  return <>
    {/* BACKGROUND AND ANIMATION START */}
    <svg className='background-animation z-0 bg-red-500' version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
